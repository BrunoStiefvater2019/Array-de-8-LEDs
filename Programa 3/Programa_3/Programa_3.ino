...
const int ButtonPin = 2 ; // declarem el botó a Pin 2 
int ButtonState = 0 ; // variable per declarar l'estat del botó , per monitoritzar-ho amb el loop.
//********** Setup ****************************************************************
void setup()
{
  pinMode(ButtonPin, INPUT); // declarem el botó  com a entrada 
...
void loop()
{
  ButtonState = digitalRead(ButtonPin); // Monitoritza l'estat del botó 
  if (ButtonState == HIGH ) {    // Si el botó està apretat farà la seguent sequencia
